function TooltipManager() {
    this.displayItemTooltip = function displayItemTooltip(item1, item2, item3, left, top, canSell) {
        ...
        if (item1.itemRarity > 0) { stats2 += "<br>Item Rarity: " + item1.itemRarity.formatPercentageMultiplier(); }
        if (item1.goldGain > 0) { stats2 += "<br>Gold Gain: " + item1.goldGain.formatPercentageMultiplier(); }
